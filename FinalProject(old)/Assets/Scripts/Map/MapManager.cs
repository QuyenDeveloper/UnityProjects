...
public class MapManager : MonoBehaviour
{
    ...
    public void CreateEntity(string entity, Vector2 position)
    {
        ...
        {
            case "Player":
                Instantiate(playerPrefab, new Vector3(position.x + 0.5f, position.y + 0.5f, 0), Quaternion.identity).name = "Player";
                break;
            case "Orc":
                Instantiate(orcPrefab, new Vector3(position.x + 0.5f, position.y + 0.5f, 0), Quaternion.identity).name = "Orc";
                break;
            case "Troll":
                Instantiate(trollPrefab, new Vector3(position.x + 0.5f, position.y + 0.5f, 0), Quaternion.identity).name = "Troll";
                break;
            default:
    ...
    public void UpdateFogMap(List<Vector3Int> playerPOV)
    {
        ...
        foreach(Vector3Int pos in playerPOV)
        {
